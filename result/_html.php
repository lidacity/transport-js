...
(function (doc, stops, routes) {
    ...
    var tpl = {
        title: '(TITLE)',
        text: '(TEXT)',
        block: '<div class="w3-col m3 l3 w3-padding-small"><div class="w3-card-4 w3-white"><header class="w3-container w3-center w3-teal"><p>(TITLE)</p></header><div class="w3-container"><p>(TEXT)</p></div></div></div>'
    };
