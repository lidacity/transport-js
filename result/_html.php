...
<body class="w3-light-grey w3-padding-small">

<noscript>
    <div class="w3-row w3-padding-small">
        <div class="w3-card-4 w3-yellow">
            <div class="w3-container">
                <p>Для работы расписания необходимо включить (разрешить) выполнение JavaScript</p>
            </div>
        </div>
    </div>
</noscript>
...
<div id="form" class="w3-row">
    <div class="w3-col m3 l3 w3-padding-small">
        <div class="w3-group">
            <label class="w3-label">Начало:</label>
            <button class="w3-btn w3-round" type="reset" onclick="location.reload()">Очистить выбор</button>
        </div>
    </div>
    <div class="w3-col m3 l3 w3-padding-small">
        <div class="w3-group">
            <label class="w3-label">Откуда:</label>
            <select class="w3-select w3-large" id="from"></select>
        </div>
    </div>
    <div class="w3-col m3 l3 w3-padding-small">
        <div class="w3-group">
            <label class="w3-label">Куда:</label>
            <select class="w3-select w3-large" id="to"></select>
        </div>
    </div>
    <div class="w3-col m3 l3 w3-padding-small">
        <div class="w3-group">
            <label class="w3-label">Обратно:</label>
            <button class="w3-btn w3-round w3-blue" id="revert" type="button">Переставить остановки</button>
        </div>
    </div>
</div>

<div id="empty" class="w3-row w3-padding-small" style="display:none">
    <div class="w3-card-4 w3-blue-grey">
        <div class="w3-container">
            <p>Подходящие маршруты не найдены. Попробуйте выбрать другие остановки.</p>
        </div>
    </div>
</div>

<div id="same" class="w3-row w3-padding-small" style="display:none">
    <div class="w3-card-4 w3-yellow">
        <div class="w3-container">
            <p>Конечная остановка совпадает с начальной. Ехать никуда не нужно?</p>
        </div>
    </div>
</div>
...
<p><img src="<?= $icon ?>"></p>
        ...
        <div class="w3-col m3 l3 w3-padding-small">
            <div class="w3-card-4 w3-white">
                <div class="w3-container">
<p>Автор сборки (составитель):<br><?= $vendor ?></p>
<p>Версия сборки: <?= $version ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="w3-col m3 l3 w3-padding-small">
            <div class="w3-card-4 w3-white">
                <div class="w3-container">
<p>Для сборки расписания в удобный для просмотра формат использован &laquo;Конструктор расписания транспорта&raquo;:<br><a href="http://luxovicy.ru/transport">luxovicy.ru/transport</a></p>
                </div>
            </div>
        </div>
...
<script>
(function(k,n,f){function v(a){var b,c;a.length=0;a[0]=new Option("\u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043e\u0441\u0442\u0430\u043d\u043e\u0432\u043a\u0443...","");b=0;for(c=n.length;b<c;b+=1)a.add(new Option(n[b],b))}function g(){var a=p.value,b=q.value,c,l;if(a===b)t("same");else if(a.length&&b.length){var a=+a,b=+b,h,d,e,g,m,r,n=[];if("undefined"===typeof f.length)a=void 0;else{c=0;for(l=f.length;c<l;c+=1)if("undefined"!==typeof f[c].stops.length){h=f[c].stops;for(d=0;d<h.length&&
h[d]!==a;)d+=1;if(d<h.length-1){for(e=h.length-1;e>d&&h[e]!==b;)--e;if(e!==d){g=[];m=0;for(h=f[c].trips.length;m<h;m+=1)r=f[c].time[m].split(","),r[d].length&&r[e].length&&g.push(r[d]+" - "+r[e]+" "+f[c].trips[m]);n.push({title:f[c].title,list:g})}}}a=n}if(a.length){l="";b=0;for(c=a.length;b<c;b+=1)d=a[b],e=u.block.replace(u.title,d.title),e=e.replace(u.text,d.list.join("<br>")),l+=e;k.getElementById("result").innerHTML=l;t("result")}else t("empty")}}function w(){var a=p.selectedIndex;p.selectedIndex=
q.selectedIndex;q.selectedIndex=a;g()}function t(a){k.getElementById("result").style.display="result"===a?"block":"none";k.getElementById("empty").style.display="empty"===a?"block":"none";k.getElementById("same").style.display="same"===a?"block":"none"}var p=k.getElementById("from"),q=k.getElementById("to"),u={title:"_TITLE_",text:"_TEXT_",block:"<div class=\"w3-col m3 l3 w3-padding-small\"><div class=\"w3-card-4 w3-white\"><header class=\"w3-container w3-center w3-teal\"><p>_TITLE_</p></header><div class=\"w3-container\"><p>_TEXT_</p></div></div></div>"};v(p);v(q);p.onchange=g;q.onchange=g;k.getElementById("revert").onclick=w;return{update:g,revert:w}})(this.document,<?= $stops ?>,<?= $routes ?>);
